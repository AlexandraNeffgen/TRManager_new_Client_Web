<%@ Page Title="Konto verwalten" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="TRManager_new_client_web.Account.Manage" %>
        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd><%: LoginsCount %>
                        <asp:HyperLink NavigateUrl="/Account/ManageLogins" Text="[Verwalten]" runat="server" />
                    ...
                    <% if (HasPhoneNumber)
                       { %>
                    <dd>
                        <asp:HyperLink NavigateUrl="/Account/AddPhoneNumber" runat="server" Text="[Hinzufügen]" />
                    </dd>
                    <% }
                       else
                       { %>
                    <dd>
                        ...
                        <asp:HyperLink NavigateUrl="/Account/AddPhoneNumber" runat="server" Text="[Ändern]" /> &nbsp;|&nbsp;
                        <asp:LinkButton Text="[Entfernen]" OnClick="RemovePhone_Click" runat="server" />
                    </dd>
                    <% } %>
                    --%>
                    ...
                    <dd>
                        ...
                        <%--
                        Aktiviert
                        <asp:LinkButton Text="[Deaktivieren]" runat="server" CommandArgument="false" OnClick="TwoFactorDisable_Click" />
                        --%>
                        <% }
                          else
                          { %> 
                        <%--
                        Deaktiviert
                        <asp:LinkButton Text="[Aktivieren]" CommandArgument="true" OnClick="TwoFactorEnable_Click" runat="server" />
                        --%>
                        <% } %>
                    </dd>
                </dl>
