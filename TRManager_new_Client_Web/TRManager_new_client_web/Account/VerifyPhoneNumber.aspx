<%@ Page Title="Telefonnummer überprüfen" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="TRManager_new_client_web.Account.VerifyPhoneNumber" %>
